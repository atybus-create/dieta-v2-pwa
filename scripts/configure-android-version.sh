...
text = text.replace(old_code, 'versionCode 2', 1)
text = text.replace(old_name, 'versionName "1.0.1"', 1)
p.write_text(text)
PY

grep -F 'versionCode 2' "$GRADLE_FILE"
grep -F 'versionName "1.0.1"' "$GRADLE_FILE"
