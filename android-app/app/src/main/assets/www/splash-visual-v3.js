...
.wczai-v3-line{position:relative;width:100%;height:17px;border-radius:999px;background:#071b20;overflow:hidden;box-shadow:0 0 0 2px rgba(36,226,213,.62),0 0 24px rgba(35,211,200,.18)}
.wczai-v3-line span{position:absolute;inset:-2px auto -2px -2px;display:block;width:calc(100% + 4px);transform-origin:left center;transform:scaleX(.04);border-radius:999px;background:linear-gradient(90deg,#20d8d0,#65f2e4 78%,#a9fff7);box-shadow:0 0 20px rgba(61,232,217,.72);animation:v3Progress 4.75s cubic-bezier(.1,.55,.2,1) .18s forwards}
