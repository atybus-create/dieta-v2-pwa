(function installStaticFullscreenSplash(){
  ...
  style.id='wczai-static-splash-v1';
  style.textContent=`
...
.wczai-static-loader{position:absolute;left:19.5%;right:18.2%;bottom:10.2%;height:16px;border-radius:999px;background:#06262b;border:1.5px solid rgba(0,238,238,.82);box-shadow:0 0 12px rgba(0,238,238,.25);overflow:hidden}
...
@media(max-width:380px){.wczai-static-loader{height:13px}}
@media(prefers-reduced-motion:reduce){.wczai-static-loader>span{animation:none;transform:scaleX(1)}}
`;
  document.head.appendChild(style);

  splash.innerHTML='<div class="wczai-static-wrap"><img class="wczai-static-art" alt="" aria-hidden="true"><div class="wczai-static-loader" aria-hidden="true"><span></span></div></div>';
